...
import android.util.Slog;
    ...
    public abstract class BroadcastReceiver {
         ...
         *
         * @return Returns a {@link android.content.BroadcastReceiver.PendingResult} representing the result of
         * the active broadcast.  The BroadcastRecord itself is no longer active;
         * all data and other interaction must go through {@link android.content.BroadcastReceiver.PendingResult}
        ...
        public final android.content.BroadcastReceiver.PendingResult goAsync() {
            android.content.BroadcastReceiver.PendingResult res = mPendingResult;
            mPendingResult = null;
            return res;
        }
         ...
         * calls to {@link Context#registerReceiver(android.content.BroadcastReceiver, IntentFilter)
         * Context.registerReceiver()}.
         * If called with true, before given to registerReceiver(), then the
         * callstack of the following {@link Context#unregisterReceiver(android.content.BroadcastReceiver)
